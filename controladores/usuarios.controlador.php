			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('marco.sotomayor@tecsup.edu.pe', 'Monadas Glamour');

					$mail->addReplyTo('marco.sotomayor@tecsup.edu.pe', 'Monadas Glamour');
					...
					<center><img style="padding:20px; width:10%" src="https://scontent-lim1-1.cdninstagram.com/v/t51.2885-15/e35/72475451_462407104661461_1511877978192059641_n.jpg?_nc_ht=scontent-lim1-1.cdninstagram.com&_nc_cat=101&_nc_ohc=K86AdB3FM50AX-lu8qD&oh=2a243263a4e4c6184e2385757cc73183&oe=5F69A3FE"></center>
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
							...
							<div style="line-height:60px; background:rgb(162, 141, 148); width:60%; color:white">Verifique su dirección de correo electrónico</div>
					...
					if($respuesta2  == "ok"){
						...
						<center><img style="padding:20px; width:10%" src="https://scontent-lim1-1.cdninstagram.com/v/t51.2885-15/e35/72475451_462407104661461_1511877978192059641_n.jpg?_nc_ht=scontent-lim1-1.cdninstagram.com&_nc_cat=101&_nc_ohc=K86AdB3FM50AX-lu8qD&oh=2a243263a4e4c6184e2385757cc73183&oe=5F69A3FE"></center>
								...
								<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
									...
									<div style="line-height:60px; background:rgb(162, 141, 148); width:60%; color:white">Ingrese nuevamente al sitio</div>
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				=============================================*/
					...
					$mail->addAddress("marco.sotomayor@tecsup.edu.pe");
