		...
		<div class="modal-body modalTitulo">
			...
			<div class="contenidoCheckout">
				...
				<div class="formaPago row">
					...
					<h4 class="text-center well text-muted text-uppercase">Método de pago por Paypal</h4>

					<figure class="col-xs-6">
						
						<center>
							
							<input id="checkPaypal" type="radio" name="pago" value="paypal" checked class="hidden">
					...
					<img src="<?php echo $url; ?>vistas/img/plantilla/Monadas.jpg" class="img-thumbnail" style="height:125px;width:250px;">

					</figure>
					<!--=====================================
					VENTANA MODAL PARA payu
